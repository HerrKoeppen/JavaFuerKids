...
public class Monster4A extends JFrame implements ActionListener
{
  ...
  public KeyListener Tastenwaechter = new KeyAdapter()
  {
    ...
    {
      if (Ereignis.getKeyChar() == (char)KeyEvent.VK_ENTER) showMonsters ();
 	}
  };
  ...
  public Monster4A ()
  {
    ...
    Knopf.addKeyListener (Tastenwaechter);
  ...
  {
    Monster4A Rahmen = new Monster4A();
