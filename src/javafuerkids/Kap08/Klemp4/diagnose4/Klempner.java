...
public class Klempner extends JFrame
  implements ActionListener, AdjustmentListener //, WindowListener
{
  // Attribute
  ...
  final String Sammelname = "d:\\Java\\Projekte\\PsychoX.txt";
  ...
  public void writeDiagnoseText () 
  {
    // Datei öffnen und "füllen"
    try
    {
      BufferedWriter Datei = new BufferedWriter (new FileWriter(Sammelname));
