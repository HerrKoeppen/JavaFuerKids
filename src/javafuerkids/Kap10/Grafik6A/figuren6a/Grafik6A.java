...
public class Grafik6A extends JFrame implements ActionListener
{
  ...
  public void drawImage()
  {
    ...
    // Bunte Kreise
   	...
   	for (int i = 1; i < 300; i++)
   	{
   	  ...
   	  Stift.fillRect (x, y, Dicke, Dicke);
   	  // Stift.setColor (Farbe[0]);
   	  // Stift.drawRect (x, y, Dicke, Dicke);
   	}
  }
