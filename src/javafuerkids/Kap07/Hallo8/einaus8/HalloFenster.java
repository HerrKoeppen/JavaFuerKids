...
public class HalloFenster extends JFrame implements ActionListener
{
  ...
  public HalloFenster ()
  {
    ...
    Links.setBorder  (BorderFactory.createBevelBorder(0)); // RAISED
    Rechts.setBorder (BorderFactory.createBevelBorder(1)); // LOWERED
    //Links.setBorder  (BorderFactory.createBevelBorder(BevelBorder.RAISED));
